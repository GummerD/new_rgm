          ...
          <div class="card-body">
            ...
            <div class="">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input  type="number" step="1" id="num_task" type="integer" class="inpt_reg_login" name="num_task"
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <textarea id="task_text" type="text" class=""  name="task_text"
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="rule_use" type="text" class="inpt_reg_login"  name="rule_use"
                    value="{{ old('rule_use') }}">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="correct_answer" type="text" class="inpt_reg_login"  name="correct_answer"
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  <input id="string_task" type="text" class="inpt_reg_login"  name="string_task"
